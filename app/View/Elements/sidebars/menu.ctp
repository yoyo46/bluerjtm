    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php
                    ...
                    $dataMenu = array(
                        'trucks' => array(
                            ...
                            'leadtime_report', 'profit_loss', 'report_mutations',
                        ),
                        'revenues' => array(
                    ...
                    if( $this->Common->allowMenu( $dataMenu ) ) {
                        ...
                        $truckMenu = array(
                            ...
                            'report_expense_per_truck', 'achievement_rit_report',
                            'profit_loss_truck', 'report_mutations'
                        );
            ...
            <li class="treeview <?php echo $activeTruck; ?>">
                ...
                <ul class="treeview-menu">
                    <?php 
                            ...
                            echo $this->Html->tag('li', $this->Html->link(__('%s Laporan Mutasi Truk', $this->Common->icon('angle-double-right')), array(
                                'controller' => 'trucks',
                                'action' => 'report_mutations',
                            ), array(
                                'escape' => false
                            )), array(
                                'class' => ( !empty($active_menu) && $active_menu == 'report_mutations' )?'active':'',
                            ));
                    ?>
                </ul>
            </li>
            ...
            <li class="treeview <?php echo $activeTtuj; ?>">
                ...
                <ul class="treeview-menu">
                    <?php 
                            ...
                            echo $this->Html->tag('li', $this->Html->link('<i class="fa fa-angle-double-right"></i> Bon Biru', array(
                                'controller' => 'ttujs',
                                'action' => 'bon_biru',
                            ), array(
                                'escape' => false
                            )), array(
                                'class' => ( !empty($active_menu) && $active_menu == 'bon_biru' )?'active':'',
                            ));
            ...
            <li class="treeview <?php echo $activeMenu; ?>">
                ...
                <ul class="treeview-menu">
                    <?php 
                             echo $this->Html->tag('li', $this->Html->link('<i class="fa fa-angle-double-right"></i> Hutang Karyawan', array(
                                'controller' => 'debt',
                                'action' => 'index',
                            ), array(
                                'escape' => false
                            )), array(
                                'class' => ( !empty($active_menu) && $active_menu == 'debt' )?'active':'',
                            ));

                            echo $this->Html->tag('li', $this->Html->link('<i class="fa fa-angle-double-right"></i> Pembayaran Hutang', array(
                                'controller' => 'debt',
                                'action' => 'payments'
                            ), array(
                                'escape' => false
                            )), array(
                                'class' => ( !empty($active_menu) && $active_menu == 'debt_payments' )?'active':'',
                            ));

                             echo $this->Html->tag('li', $this->Html->link('<i class="fa fa-angle-double-right"></i> Kartu Hutang', array(
                                'controller' => 'debt',
                                'action' => 'reports',
                            ), array(
                                'escape' => false
                            )), array(
                                'class' => ( !empty($active_menu) && $active_menu == 'debt_reports' )?'active':'',
                            ));
                    ?>
                </ul>
            </li>
