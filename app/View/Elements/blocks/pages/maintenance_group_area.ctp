...
<div class="box-header">
    <?php
            ...
            echo $this->Html->tag('h3', __('Chart Biaya Perbaikan Truk'), array(
                'class' => 'box-title',
            ));
    ?>
    <div class="pull-right box-tools">
        <?php
                echo $this->Common->_callInputForm('select_year', array(
                    ...
                    'value' => $year,
                    'data-target' => '#maintenance-pie-chart',
                ));
        ?>
    </div>
</div>
<div class="box-body">
    <?php
            ...
            echo $this->Html->tag('div', '', array(
                'id' => 'maintenance-pie-chart',
                'class' => 'load-chart',
                'style' => 'height: 280px;',
                'data-target' => '#maintenance-pie-chart',
                'data-url' => $urlMaintenance,
                'data-type' => 'pie',
                'data-form' => '#form-maintenance',
            ));
    ?>
</div><!-- /.box-body-->
