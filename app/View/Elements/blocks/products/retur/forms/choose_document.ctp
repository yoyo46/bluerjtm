...
<div class="wrapper-write-document">
	<?php 
			echo $this->Common->buildInputForm('ProductRetur.vendor_id', __('Supplier'), array(
				'type' => 'select',
	...
	<div class="form-group">
		...
		<div class="row">
			<div class="col-sm-10">
				<?php
						echo $this->Common->buildInputForm('ProductRetur.document_number', false, array(
							'frameClass' => false,
							'id' => 'document-number',
							'attributes' => array(
							...
							'fieldError' => 'ProductRetur.document_id',
						));
