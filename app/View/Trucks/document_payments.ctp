<?php 
        ...
        echo $this->element('blocks/trucks/searchs/document_payments');
?>
<div class="box">
    ...
    <div class="box-body table-responsive">
        <table class="table table-hover">
            <tr>
                <?php
                        echo $this->Html->tag('th', $this->Paginator->sort('DocumentPayment.id', __('No. Referensi'), array(
                            'escape' => false
                        )));
                        ...
                        echo $this->Html->tag('th', $this->Paginator->sort('DocumentPayment.status', __('Status'), array(
                            'escape' => false
                        )), array(
                            'class' => 'text-center'
                        ));
            ...
            <tr>
                <?php 
                        ...
                        $actionDoc = $this->Html->link('Detail', array(
                            'controller' => 'trucks',
                            'action' => 'document_payment_detail',
                            $id,
                        ), array(
                        ...
                        if(empty($is_canceled)){
                            ...
                            $actionDoc .= $this->Html->link(__('Void'), array(
                                'controller' => 'trucks',
                                'action' => 'document_payment_delete',
                                $id,
                            ), array(
