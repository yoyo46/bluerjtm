<?php 
        $element = 'blocks/ttuj/tables/report_bon_biru';
        $full_name = !empty($User['Employe']['full_name'])?$User['Employe']['full_name']:false;
        $dataColumns = array(
            'noref' => array(
                'name' => __('No. Ref'),
                'field_model' => 'BonBiru.id',
            ...
            'date' => array(
                ...
                'field_model' => 'BonBiru.tgl_bon_biru',
                'style' => 'text-align: center;vertical-align: middle;',
        ...
        if( !empty($data_action) ){
            ...
            echo $this->element('blocks/ttuj/searchs/report_bon_biru');
?>
