<?php
		...
		echo $this->Form->create('SpkPayment');
?>
...
<?php     	
        echo $this->element('blocks/spk/payments/tables/detail');
?>
<div class="box-footer text-center action">
	<?php
			...
			if( empty($view) ) {
				$this->Common->_getButtonPostingUnposting( $value, 'SpkPayment', array( 'Commit', 'Draft' ) );
			}
	?>
</div>
<?php
