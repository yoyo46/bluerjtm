<?php 
        ...
        echo $this->element('blocks/spk/payments/forms/search');
?>
<div class="box">
    <?php 
            ...
            <?php
                    if(!empty($values)){
                        foreach ($values as $key => $value) {
                            $id = $this->Common->filterEmptyField($value, 'SpkPayment', 'id');
                            $nodoc = $this->Common->filterEmptyField($value, 'SpkPayment', 'nodoc');
                            $transactionDate = $this->Common->filterEmptyField($value, 'SpkPayment', 'transaction_date');
                            $periode = $this->Common->filterEmptyField($value, 'SpkPayment', 'transaction_date', false, false, array(
                                'date' => 'Y-m',
                            ));
                            $note = $this->Common->filterEmptyField($value, 'SpkPayment', 'note');
                            $grandtotal = $this->Common->filterEmptyField($value, 'SpkPayment', 'grandtotal');
                            $transaction_status = $this->Common->filterEmptyField($value, 'SpkPayment', 'transaction_status');
