...
<div class="box">
	...
	<div class="box-body table-responsive">
		<table class="table table-hover">
			<thead>
        		<tr>
        			<th class="text-left"><?php echo __('No Kontrak');?></th>
	                <th class="text-right"><?php echo __('DP');?></th>
	                <th class="text-right"><?php echo __('Denda');?></th>
	                <th class="text-right"><?php echo __('Total');?></th>
        		</tr>
        	</thead>
        	<tbody>
                <?php
		    			echo $this->element('blocks/leasings/leasing_dp_payment_detail');
		    	?>
        	</tbody>
		</table>
	</div>
