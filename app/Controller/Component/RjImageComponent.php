		...
		// if( !$result['error'] ) {
			...
			if($this->options['rar'] == false){
				...
				if( !file_exists($fullsizePath) ) {
					mkdir($fullsizePath, 0755, true);
					chmod($fullsizePath, 0755);
				}
